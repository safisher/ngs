...
ngsCmd_HTSEQ() {
	...
	prnCmd "egrep '\t' $SAMPLE/htseq/tmp.txt | egrep -v 'no_feature|ambiguous|too_low_aQual|not_aligned|alignment_not_unique' > $SAMPLE.htseq.cnts.txt"
	prnCmd "egrep -v '\t' $SAMPLE/htseq/tmp.txt > $SAMPLE.htseq.log.txt"
	prnCmd "egrep 'no_feature|ambiguous|too_low_aQual|not_aligned|alignment_not_unique' $SAMPLE/htseq/tmp.txt >> $SAMPLE.htseq.log.txt"
	...
	if ! $DEBUG; then 
		...
		egrep '\t' $SAMPLE/htseq/tmp.txt | egrep -v 'no_feature|ambiguous|too_low_aQual|not_aligned|alignment_not_unique' > $SAMPLE.htseq.cnts.txt
		egrep -v '\t' $SAMPLE/htseq/tmp.txt > $SAMPLE.htseq.log.txt
		egrep 'no_feature|ambiguous|too_low_aQual|not_aligned|alignment_not_unique' $SAMPLE/htseq/tmp.txt >> $SAMPLE.htseq.log.txt
